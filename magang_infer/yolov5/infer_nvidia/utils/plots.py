...
from yolov5.infer_nvidia.utils.general import (CONFIG_DIR, FONT, LOGGER, Timeout, check_font, check_requirements, clip_coords,
                           increment_path, is_ascii, is_chinese, try_except, xywh2xyxy, xyxy2xywh)
from yolov5.infer_nvidia.utils.metrics import fitness
