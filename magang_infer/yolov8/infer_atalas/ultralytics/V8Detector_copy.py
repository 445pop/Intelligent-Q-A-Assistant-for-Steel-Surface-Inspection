...
class Detector:
    ...
    def __init__(self, gpu_id='0'):
        ...
        # self.device = gpu_id
        self.model_path = r"/home/hongtai/workspace/XX_infer_project/yolov8/infer_atalas/ultralytics/best_0409_bs32.om"
        # self.parse_setting()
...
if __name__ == '__main__':
    print('hello1')
    detect = Detector()
    a = cv2.imread("/home/hongtai/workspace/XX_infer_project/0411_test_imgs/hs_09268.png")
    print(a.shape)
    imgs = [a] *64
