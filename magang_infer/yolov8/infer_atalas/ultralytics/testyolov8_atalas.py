...
class Detector:
    ...
    def __init__(self, gpu_id='0'):
        ...
        # self.device = gpu_id
        self.model_path = r"/home/hongtai/workspace/XX_infer_project/yolov8/infer_atalas/ultralytics/nnl_bs1.om"
        # self.parse_setting()
    ...
    def infer_one_pic(self,img,imginfo,shape):
        ...
        # img = torch.from_numpy(img).float()  # .float()?  tensor            float  
        # img = np.concatenate((img, img), axis=0) 
        print(img.shape)
        print(imginfo,shape)
        preds = self.model.infer([img])
        # non_max_suppression
        boxout = non_max_suppression(preds, conf_thres=0.1, iou_thres=0.3)
...
if __name__ == '__main__':
    print('hello1')
    detect = Detector()
    a = cv2.imread("/home/hongtai/workspace/XX_infer_project/yolov8/infer_atalas/ultralytics/00001.jpg")
    print('hello')
    imgs = [a] * 1
